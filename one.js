    ...
    "node_modules/@hastom/fixed-point/dist/FixedPoint.js"(exports) {
      ...
      var FixedPoint = class _FixedPoint {
        ...
        add(arg, resultPrecision) {
          ...
          const targetPrecision = pickPrecision(
            aPrecision,
            bPrecision,
            resultPrecision ?? Decimals.left
          )
        ...
        div(arg, resultPrecision) {
          ...
          const result = new _FixedPoint(
            (0, math_1.toPrecision)(newBase, calcPrecision, aPrecision),
            calcPrecision
          )
          result.setPrecision(targetPrecision)
          return result
        ...
        sqrt() {
          ...
          const workingThis = new _FixedPoint(
            (0, math_1.toPrecision)(this.base, workingPrecision, this.precision),
            workingPrecision
          )
        ...
        setPrecision(newPrecision, rounding = Rounding.ROUND_DOWN) {
          if (newPrecision < this.precision) {
            const rounded = new _FixedPoint(this.base, this.precision - newPrecision).round(
              rounding
            )
        ...
        toPrecision(resultPrecision, rounding = Rounding.ROUND_DOWN) {
          ...
          if (newPrecision < this.precision) {
            ...
            return new _FixedPoint(
              (0, math_1.toPrecision)(rounded.base, newPrecision, this.precision),
              newPrecision
            )
          } else {
            return new _FixedPoint(
              (0, math_1.toPrecision)(this.base, newPrecision, this.precision),
              newPrecision
            )
          }
        }
        ...
        toDecimalString() {
          const isNegative = this.isNegative()
          let str = (0, math_1.abs)(this.base)
            .toString()
            .padStart(Number(this.precision) + 1, "0")
          if (isNegative) {
            str = `-${str}`
          }
          if (this.precision === 0n) {
  ...
  var require_parsers = __commonJS({
    "node_modules/@hastom/fixed-point/dist/parsers.js"(exports) {
      ...
      var fpFromInt = (src, srcPrecision, dstPrecision) => {
        ...
        const _dstPrecision = BigInt(dstPrecision)
        return new FixedPoint_1.FixedPoint(
          (0, math_1.toPrecision)(BigInt(src), _dstPrecision, _srcPrecision),
          _dstPrecision
        )
      }
  ...
  var require_dist = __commonJS({
    "node_modules/@hastom/fixed-point/dist/index.js"(exports) {
      ...
      exports.toPrecision =
        ...
        exports.min =
        exports.fpFromInt =
        exports.fpFromDecimal =
        exports.Rounding =
        exports.Decimals =
        exports.FixedPoint =
          void 0
      var FixedPoint_1 = require_FixedPoint()
      Object.defineProperty(exports, "FixedPoint", {
        enumerable: true,
        get: function () {
      ...
      Object.defineProperty(exports, "fpFromDecimal", {
        enumerable: true,
        get: function () {
          return parsers_1.fpFromDecimal
        },
      })
      Object.defineProperty(exports, "fpFromInt", {
        enumerable: true,
        get: function () {
...
runtime.variables["result"] = 3 * (1 + 1) == 6 ? "fantastic" : "huh?"

runtime.variables["log"](runtime.variables["result"])
