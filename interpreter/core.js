const { createMemoryObject, bootstrap } = runtime

const { getBaseFields } = require("./coreLibrary")

const createCore = ({ controlFlow, scope }) => {
  let execute
  const executeIsReady = newExecute => {
    execute = newExecute
  }
